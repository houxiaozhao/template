...
db.getCollection('permissions').insert({
  ...
  _id: ObjectId('603c949daca3cb1ec82cc0db'),

  alias: '设备管理权限',

  apis: [
    ObjectId('603c8efd6cc81911f06163fa'),

    ObjectId('603c8efd6cc81911f06163e9'),

    ObjectId('603c8efd6cc81911f06163e1'),

    ObjectId('603c8efd6cc81911f06163d9'),

    ObjectId('603c8efd6cc81911f06163f1'),
  ],

  buttons: [],

  createdAt: ISODate('2021-03-01T07:15:41.361Z'),

  menus: [ObjectId('603c8f9aaf9b704534781035')],

  updatedAt: ISODate('2021-03-01T07:15:41.361Z'),
});
...
db.getCollection('roles').insert({
  ...
  _id: ObjectId('603c94bcaca3cb1ec82cc0dc'),

  alias: '设备管理角色',

  company: ObjectId('603c92b3aca3cb1ec82cc0d8'),

  createdAt: ISODate('2021-03-01T07:16:12.563Z'),

  permissions: [ObjectId('603c949daca3cb1ec82cc0db')],

  updatedAt: ISODate('2021-03-01T07:16:12.563Z'),
});
db.getCollection('users').insert({
  ...
  roles: [
    ...
    ObjectId('603c94bcaca3cb1ec82cc0dc'),
  ],
  ...
  updatedAt: ISODate('2021-03-01T07:16:53.677Z'),
